...
admin.site.site_header = "TBC"
admin.site.site_title = "TBC Admin Portal"
admin.site.index_title = "TBC Admin"

# swagger
api_info = openapi.Info(
    title="TBC API",
    default_version="v1",
    description="API documentation for TBC App",
)
